  ...
  var RelayQLPrinter = (function() {
    ...
    _createClass(RelayQLPrinter, [{
      ...
      value: function printQuery(query) {
        ...
        if (rootFieldArgs.length === 1) {
          ...
          calls = t.arrayExpression([codify({
            ...
            metadata: objectify({type: this.printArgumentTypeForMetadata(identifyingArg.getType())}),
      ...
      value: function printFragment(fragment) {
        ...
        var metadata = this.printRelayDirectiveMetadata(fragment, {isAbstract: fragmentType.isAbstract()});
        return codify({
          children: selections,
      ...
      value: function printMutation(mutation) {
        ...
        var selections = this.printSelections(rootField, requisiteFields);
        var metadata = {inputType: this.printArgumentTypeForMetadata(rootField.getDeclaredArgument(INPUT_ARGUMENT_NAME))};
        return codify({
          calls: t.arrayExpression([codify({
            kind: t.valueToNode('Call'),
            metadata: objectify({}),
